...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GateClosed_OUT_GPIO_Port, GateClosed_OUT_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(UseGate_OUT_GPIO_Port, UseGate_OUT_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : GateClosed_OUT_Pin */
  GPIO_InitStruct.Pin = GateClosed_OUT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GateClosed_OUT_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : UseGate_OUT_Pin */
  GPIO_InitStruct.Pin = UseGate_OUT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(UseGate_OUT_GPIO_Port, &GPIO_InitStruct);
